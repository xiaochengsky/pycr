...
train_pipeline = [
    ...
    dict(type="RandomPatch", p=0.1, pool_capacity=50000, min_sample_size=100, patch_min_area=0.01, patch_max_area=0.2, patch_min_ratio=0.2, p_rotate=0.5, p_flip_left_right=0.5),
