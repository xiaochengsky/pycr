...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_prefix='data/esfair/fold_0/esfair_train_fold0.txt',
        pipeline=train_pipeline,
    ),

    val=dict(
        type=dataset_type,
        data_prefix='data/esfair/fold_0/esfair_val_fold0.txt',
    ...
    collect=None,       # collect=True when dataloader is Triplet
)
