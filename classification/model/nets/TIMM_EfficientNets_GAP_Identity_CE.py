...
class TIMM_EfficientNet_B4_GAP_Identity_CE(nn.Module):
    def __init__(self, cfg):
        super(TIMM_EfficientNet_B4_GAP_Identity_CE, self).__init__()
        self.cfg = cfg
...
class TIMM_EfficientNet_B5_GAP_Identity_CE(nn.Module):
    def __init__(self, cfg):
        super(TIMM_EfficientNet_B5_GAP_Identity_CE, self).__init__()
        self.cfg = cfg
        cfg_model = self.cfg['model']
        cfg_model = deepcopy(cfg_model)
...
class EfficientNet_B4_GAP_Identity_SnapMix_CE(nn.Module):
    def __init__(self, cfg):
        super(EfficientNet_B4_GAP_Identity_SnapMix_CE, self).__init__()
        self.cfg = cfg
        cfg_model = self.cfg['model']
        cfg_model = deepcopy(cfg_model)
    ...
    def forward(self, inputs, targets=None, extract_features_flag=False, features_type="after", ya=None, yb=None, lam_a=None, lam_b=None, reback=None):
        ...
        if self.training:
            ...
            if reback is None:
                ...
                return pred_logit, b_features.detach()
