...
config = dict(
    ...
    # Model config
        ...
        ## losses:              model loss
    model=dict(
        net=dict(type='ResNet'),
        backbone=dict(type='resnet50', pretrained=False),
        aggregation=dict(type="GeM", output_size=(1, 1), ),
        heads=dict(type='BNneckHead', in_feat=2048, num_classes=5),
        losses=[
