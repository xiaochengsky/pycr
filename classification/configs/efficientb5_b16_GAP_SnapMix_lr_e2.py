...
config = dict(
    ...
    # Model config
        ...
        ## losses:              model loss
    model=dict(
        net=dict(type='EfficientNet_B5_GAP_Identity_CE', ),
        backbone=dict(type='efficient_b5'),
        ...
        losses=[
            dict(type='EfficientNet_CELoss', networks_name='efficientnet-b5', num_classes=5, weight=1.0),
