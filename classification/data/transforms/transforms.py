...
__all__ = ["Compose", "ToTensor", "PILToTensor", "ConvertImageDtype", "ToPILImage", "Normalize", "Resize", "Scale",
           ...
           # add by ycc
           "RandomRotation90x", "RandomAddSaltPepperNoise", "RandomAddGaussianNoise", "RandomColorJitter"]
...
class RandomRotation90x(object):
    ...
    def __init__(self, degrees, resample=False, expand=False, center=None, fill=None):
        ...
        if isinstance(degrees, list):
            self.degrees = random.choice(degrees)
...
class RandomAddSaltPepperNoise(object):
    def __init__(self, p=0.2, density=0.05):
        self.p = p
...
class RandomAddGaussianNoise(object):
    def __init__(self, p=0.2, mean=0.0, variance=1.0, amplitude=10.):
        self.p = p
        self.mean = mean
